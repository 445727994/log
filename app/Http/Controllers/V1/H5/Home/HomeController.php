...
class HomeController extends WechatController
{
    ...
    {
        return view('home.index', ['banners' => Ads::ads(1), 'cates' => Ads::ads(2)]);
    }
    ...
    {
        return view('home.level', ['level' => Level::LevelMsg()]);
    }
    ...
    public function change(Request $request)
    {
        if ($request->ajax()) {
            ...
            if ($tkl && isset($tkl['tpwd'])) {
                ...
                return json(201, '请检查您输入的链接/口令', $tkl);
            }
        }
    ...
    {
        return view('home.oauth', ['oauth' => Taobao::getOauthUrl(auth('h5wechat'))]);
    }
}
